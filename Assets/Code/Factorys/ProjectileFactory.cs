...
public class ProjectileFactory
{
    ...
    public Projectile Create(string projectileId, Vector3 position, Quaternion rotation, ProjectileConfig config, bool useSingleDamage = false, bool playAudio = false)
    {
        ...
        projectile.Configure(config.Target, useSingleDamage ? projectile.SingleProjectileDamage : config.Damage , config.Direction, config.Owner, playAudio);
